                      ...
                      <div class="col-lg-12">
                          <section class="panel">
                              ...
                              <div class="panel-body form-horizontal">
                                  <?php echo $this->Form->create($user, ['type' => 'post', 'id'=>'userEdit']); ?>
									...
									<div class="col-lg-offset-2 col-lg-1">
                                     <?php echo $this->Form->submit(__('Save User'), array('class' => 'btn btn-success')); ?>
									 </div>
                                     <div class="col-lg-2 text-center">
                                     <?php echo $this->Form->submit(__('Save User & Exit'), array('name'=>'se','class' => 'btn btn-info')); ?>
									 </div>
                                     <div class="col-lg-1">
									 <?php
												echo $this->Html->link(
